      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto items-stretch">
          ...
          <motion.div
            ...
            className="glass-card-orange rounded-3xl p-8 flex flex-col justify-between border relative overflow-hidden"
          >
            {/* Best Value Badge */}
            <div className="absolute top-0 right-0 bg-[#FF6A00] text-black text-[10px] font-bold tracking-widest uppercase py-1 px-4 rounded-bl-xl flex items-center gap-1">
            ...
            <div className="pt-8">
              <a
                href="#contact"
                className="w-full py-3.5 rounded-xl bg-[#FF6A00] text-black font-bold text-sm text-center block transition-all duration-300 hover:bg-[#FF8833] hover:shadow-[0_4px_20px_rgba(255,106,0,0.3)] hover:scale-[1.02]"
              >
                Choose Business
              </a>
            </div>
